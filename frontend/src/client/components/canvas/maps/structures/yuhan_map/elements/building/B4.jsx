...
Command: npx gltfjsx@6.4.1 B4.glb -o B4.jsx 
*/
...
export function B4({position, ...props}) {
  const { scene, nodes, materials } = useGLTF('/assets/models/B4.glb')
...
useGLTF.preload('/assets/models/B4.glb')

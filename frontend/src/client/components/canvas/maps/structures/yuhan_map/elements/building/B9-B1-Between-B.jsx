...
Command: npx gltfjsx@6.4.1 B9-B1-Between-B.glb -o B9-B1-Between-B.jsx 
*/
...
export function B9_B1_Between_B({position, ...props}) {
  const { scene, nodes, materials } = useGLTF('/assets/models/B9-B1-Between-B.glb')
  ...
  return (
    <group ref={meshRef}>
      <group position={[7,0,0]} rotation={[0,0,0]} scale={[-25.054, -75.261, -13.44]}>
...
useGLTF.preload('/assets/models/B9-B1-Between-B.glb')

...
Command: npx gltfjsx@6.4.1 B4Restaurant.glb -o B4Restaurant.jsx 
*/
...
export function B4Restaurant({position, ...props}) {
  const { scene, nodes, materials } = useGLTF('/assets/models/B4Restaurant.glb')
...
useGLTF.preload('/assets/models/B4Restaurant.glb')

...
Command: npx gltfjsx@6.4.1 Park1_T3.glb -o Park1_T3.jsx 
*/
...
export function Park1_T3({position, ...props}) {
  const { scene, nodes, materials } = useGLTF('/assets/models/Park1_T3.glb')
  ...
  return (
    <group ref={meshRef}>
      <group position={[60, 17.393, -16]} scale={61.994}>
...
useGLTF.preload('/assets/models/Park1_T3.glb')

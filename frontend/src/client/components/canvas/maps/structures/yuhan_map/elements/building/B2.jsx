...
Command: npx gltfjsx@6.4.1 B2.glb -o B2.jsx 
*/
...
export function B2({position, ...props}) {
  const { scene, nodes, materials } = useGLTF('/assets/models/B2.glb')
  ...
  return (
    <group ref={meshRef}>
      <group position={[0,0,0]} rotation={[0,0,0]} scale={[2.59, 1, 4.787]}>
...
useGLTF.preload('/assets/models/B2.glb')

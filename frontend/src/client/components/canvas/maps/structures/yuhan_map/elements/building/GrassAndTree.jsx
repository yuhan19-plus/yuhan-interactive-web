...
Command: npx gltfjsx@6.4.1 GrassAndTree.glb -o GrassAndTree.jsx 
*/
...
export function GrassAndTree({position, ...props}) {
  const { scene, nodes, materials } = useGLTF('/assets/models/GrassAndTree.glb')
  ...
  return (
    <group ref={meshRef}>
      <group position={[0,0,0]} rotation={[0,0,0]} scale={[12.72, 2.183, 87.156]}>
...
useGLTF.preload('/assets/models/GrassAndTree.glb')

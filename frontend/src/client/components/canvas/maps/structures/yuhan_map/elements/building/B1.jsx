...
Command: npx gltfjsx@6.4.1 B1.glb -o B1.jsx 
*/
...
export function B1({position, ...props}) {
  const { scene, nodes, materials } = useGLTF('/assets/models/B1.glb')
  ...
  return (
    <group ref={meshRef}>
      <group position={[0,0,0]} rotation={[Math.PI/2, 0, -Math.PI]} scale={[8.072, 8.072, 9.321]}>
...
useGLTF.preload('/assets/models/B1.glb')

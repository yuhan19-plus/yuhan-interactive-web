...
Command: npx gltfjsx@6.4.1 B8.glb -o B8.jsx 
*/
...
export function B8({position, ...props}) {
  const { scene, nodes, materials } = useGLTF('/assets/models/B8.glb')
...
useGLTF.preload('/assets/models/B8.glb')

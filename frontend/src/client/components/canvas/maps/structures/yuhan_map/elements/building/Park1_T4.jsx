...
Command: npx gltfjsx@6.4.1 Park1_T4.glb -o Park1_T4.jsx 
*/
...
export function Park1_T4({position, ...props}) {
  const { scene, nodes, materials } = useGLTF('/assets/models/Park1_T4.glb')
  ...
  return (
    <group ref={meshRef}>
      <group position={[50, 17.393, -50]} scale={61.994}>
...
useGLTF.preload('/assets/models/Park1_T4.glb')

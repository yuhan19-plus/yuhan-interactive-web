...
Command: npx gltfjsx@6.4.1 B3.glb -o B3.jsx 
*/
...
export function B3({position, ...props}) {
  const { scene, nodes, materials } = useGLTF('/assets/models/B3.glb')
  ...
  return (
    <group ref={meshRef}>
      <group position={[5,-5,0]} rotation={[0,0,0]} scale={[8.072, 8.072, 9.321]}>
...
useGLTF.preload('/assets/models/B3.glb')

...
Command: npx gltfjsx@6.4.1 BusStation1.glb -o BusStation1.jsx 
*/
...
export function BusStation1({position, ...props}) {
  const { scene, nodes, materials } = useGLTF('/assets/models/BusStation1.glb')
  ...
  return (
    <group ref={meshRef}>
      <group position={[-3,0,0]} scale={[1.027, 6.844, 6.844]}>
...
useGLTF.preload('/assets/models/BusStation1.glb')
